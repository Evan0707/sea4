 ...
 */
final class Version20251127075053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER INDEX batiparti.uniq_admin_noutilisateur RENAME TO UNIQ_B8E307DE51A03E9D');
        $this->addSql('ALTER TABLE batiparti.appel DROP CONSTRAINT fk_appel_nochantier');
        ...
        $this->addSql('ALTER TABLE batiparti.confier DROP CONSTRAINT fk_confier_noartisan');
        $this->addSql('ALTER TABLE batiparti.confier ADD CONSTRAINT FK_8153C53515D210BE FOREIGN KEY (noArtisan) REFERENCES batiparti.artisan (noArtisan) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE batiparti.associer DROP CONSTRAINT fk_91c771ed7347e7d');
        $this->addSql('ALTER TABLE batiparti.associer DROP CONSTRAINT fk_associer_nofacture');
        $this->addSql('ALTER TABLE batiparti.associer DROP CONSTRAINT fk_91c771eabe56fdf');
        $this->addSql('ALTER TABLE batiparti.associer ADD CONSTRAINT FK_91C771ED7347E7D FOREIGN KEY (noFacture) REFERENCES batiparti.facture_artisan (noFacture) ON DELETE CASCADE NOT DEFERRABLE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER INDEX batiparti.uniq_b8e307de51a03e9d RENAME TO uniq_admin_noutilisateur');
        $this->addSql('ALTER TABLE batiparti.associer DROP CONSTRAINT FK_91C771ED7347E7D');
        $this->addSql('ALTER TABLE batiparti.associer DROP CONSTRAINT FK_91C771EABE56FDF');
