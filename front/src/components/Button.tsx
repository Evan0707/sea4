...
const Button = ({
  ...
  const variants =
    (variant=='Primary' && 'bg-primary text-white h-[42px]')
    || (variant=='Secondary' && 'border-[1.5px] border-border bg-secondary text-black h-[42px]')
    || (variant=='Destructive' && 'bg-red-bg text-red h-[42px]')
    || '';
