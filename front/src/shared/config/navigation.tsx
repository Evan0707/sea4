...
import { Home, File, Plus, Grid, Users, Tool, Inbox } from '@mynaui/icons-react'
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Accueil', path: '/maitre-doeuvre', roles: ['ROLE_MAITRE_DOEUVRE'], icon: <Home strokeWidth={1.5} size={22} /> },
  { label: 'Mes Dossiers', path: '/maitre-doeuvre/dossiers', roles: ['ROLE_MAITRE_DOEUVRE'], icon: <Inbox strokeWidth={1.5} size={22} /> },
  { label: 'Mes Projets', path: '/maitre-doeuvre/projets', roles: ['ROLE_MAITRE_DOEUVRE'], icon: <Grid strokeWidth={1.5} size={22} /> },
  ...
  { label: 'Projets', path: '/admin/projets', roles: ['ROLE_ADMIN'], icon: <Grid strokeWidth={1.5} size={22} /> },
